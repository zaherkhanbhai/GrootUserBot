...
from GrootNetwork import *
from pyrogram import Client
from pyrogram.types import Message, Chat, User
from GrootNetwork.modules.helpers.interval import IntervalHelper
import GrootNetwork.modules.cache.admins

async def get_administrators(chat: Chat) -> List[User]:
    get = GrootNetwork.modules.cache.admins.get(chat.id)
    ...
    if get:
        ...
        GrootNetwork.modules.cache.admins.set(chat.id, to_set)
